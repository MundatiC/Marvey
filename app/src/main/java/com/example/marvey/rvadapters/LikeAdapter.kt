...
import com.example.marvey.Models.LikeModel
import com.example.marvey.databinding.ShoedisplaymainItemBinding
...
class LikeAdapter(private val context: Context,
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.tvPriceShoeDisplayItem.text = "Sh${currentItem.price}"
